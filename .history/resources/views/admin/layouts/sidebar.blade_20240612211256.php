    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            <li class="menu-header">Dashboard</li>
                ...
                <a href="#" class="nav-link has-dropdown"></i><span>Dashboard</span></a>
                          <li class=active><a class="nav-link" href="index-0.html"><i class="fas fa-fire">General Dashboard</a></li>
